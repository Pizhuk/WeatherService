...
public class DBCurrentWeather {
    private DBConnection dbConnection;
    private City city;

    public DBCurrentWeather(DBConnection dbConnection, City city) {
        this.dbConnection = dbConnection;
        this.city = city;
    }

    public int insertCurrentWeatherInfo(String jsonInfo){
        ...
        try (Connection conn = dbConnection.getConnection();
             PreparedStatement statement = conn.prepareStatement(String.format(INSERT_CURRENT_WEATHER_INFO_QUERY, id,
